...
CREATE TABLE IF NOT EXISTS `aar_auth_group` (
...
--
-- 转存表中的数据 `aar_auth_group`
--

INSERT INTO `aar_auth_group` (`id`, `title`, `status`, `rules`, `describe`) VALUES
(1, '超级管理员', 1, '', '拥有最大权限'),
...
--
-- 表的结构 `aar_auth_group_access`
--

CREATE TABLE IF NOT EXISTS `aar_auth_group_access` (
...
--
-- 转存表中的数据 `aar_auth_group_access`
--

INSERT INTO `aar_auth_group_access` (`uid`, `group_id`) VALUES
(1, 1),
(2, 2);
...
CREATE TABLE IF NOT EXISTS `aar_auth_rule` (
...
--
-- 转存表中的数据 `aar_auth_rule`
--

INSERT INTO `aar_auth_rule` (`id`, `name`, `title`, `type`, `status`, `condition`, `pid`, `state`) VALUES
...
CREATE TABLE IF NOT EXISTS `aar_auth_user` (
...
--
-- 转存表中的数据 `aar_auth_user`
--

INSERT INTO `aar_auth_user` (`uid`, `username`, `password`, `lastloginip`, `lastlogintime`, `email`, `realname`, `score`, `card`, `lang`) VALUES
...
CREATE TABLE IF NOT EXISTS `aar_member` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `aar_member` (`id`, `phpssouid`, `username`, `password`, `encrypt`, `nickname`, `regdate`, `lastdate`, `regip`, `lastip`, `loginnum`, `email`, `groupid`, `areaid`, `amount`, `point`, `modelid`, `message`, `islock`, `vip`, `overduedate`, `siteid`, `connectid`, `from`, `mobile`) VALUES
...
--
-- 表的结构 `aar_member_group`
--

CREATE TABLE IF NOT EXISTS `aar_member_group` (
...
--
-- 转存表中的数据 `aar_member_group`
--

INSERT INTO `aar_member_group` (`id`, `name`, `issystem`, `starnum`, `point`, `allowmessage`, `allowvisit`, `allowpost`, `allowpostverify`, `allowsearch`, `allowupgrade`, `allowsendmessage`, `allowpostnum`, `allowattachment`, `price_y`, `price_m`, `price_d`, `icon`, `usernamecolor`, `description`, `sort`, `disabled`) VALUES
